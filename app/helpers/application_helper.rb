module ApplicationHelper
  ...
  def menu_for_client(client)
    [
      link_to(I18n.t('sigma.points'), {:controller => '/clients', :id => client.id, :action => 'points'}),
  ...
  def menu_for_cashier(cashier)
    [
      link_to(I18n.t('sigma.points'), new_point_path),
      link_to(I18n.t('sigma.promotions'), promotions_path)
    ]
  end
